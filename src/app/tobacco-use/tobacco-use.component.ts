...
@Component({
  selector: 'tobacco-use',
  templateUrl: './tobacco-use.component.html',
  styleUrls: ['./tobacco-use.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TobaccoUseComponent implements OnDestroy, EhrFormCustomComponent {
