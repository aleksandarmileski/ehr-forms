...
@Component({
  selector: 'social-ama',
  templateUrl: './social-anamesis.component.html',
  styleUrls: ['./social-anamesis.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SocialAnamesisComponent implements OnDestroy, EhrFormCustomComponent {
