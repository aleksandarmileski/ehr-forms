...
@Component({
  selector: 'alc-use',
  templateUrl: './alchohol-use.component.html',
  styleUrls: ['./alchohol-use.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AlchoholUseComponent implements OnDestroy, EhrFormCustomComponent {
